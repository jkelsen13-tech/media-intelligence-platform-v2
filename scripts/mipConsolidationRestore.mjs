...
export async function applyFoundation(db) {
  ...
  await applyMigrationFile(db, '20260905203600_mip_legacy_graph_private_staging.sql')
  await applyMigrationFile(db, '20260909153133_comparison_explanation_event_binding.sql')
}
