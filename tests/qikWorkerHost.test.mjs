...
const defaults={rpcUrl:'https://qualification.invalid/rest/v1/rpc/',apiKey:'synthetic-public',workerJwt:jwt('mip_comparison_worker_v1'),invokeToken:'synthetic-invoke',session:'synthetic-session',runtime:'synthetic-runtime',implementation:'synthetic-implementation',cryptoImpl:webcrypto}
