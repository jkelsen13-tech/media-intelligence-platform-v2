...
The first authoring browser run at 43f0e510c8d24fb8008fe4b09f3bbe33f003f6a0 failed: run 34805104132/job 103855344783 timed out locating the retained-material select by its exact intended accessible label. This is preserved as failed evidence. The correction supplies explicit accessible names for the eight composer selectors while retaining the same exact-label browser assertions, permission/hash checks and save recovery behavior. No successful authoring-browser claim applies until the corrected candidate passes.
