import {hypothesisEndpoint} from '../../tests/privateMarketsHypothesisFixture.mjs'
...
window.renderMarketsApp=({configured=true,token='synthetic-markets-current',signedOut=false,expiresAt=null,hypotheses=false}={})=>{const auth=marketsAuth(token);if(expiresAt!==null)auth.session.expires_at=expiresAt;return root.render(<App
 hypothesisEndpoint={hypotheses?hypothesisEndpoint:null}
