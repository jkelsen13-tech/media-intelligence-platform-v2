...
export function isolatedCommitRecorder(){
 guard();const name='mip-commit-'+randomUUID(),events=new EventEmitter()
 const mounts=[
 ['../../supabase/qualification/hypothesis-assessments/commitRecorder.mjs','/work/supabase/qualification/hypothesis-assessments/commitRecorder.mjs'],
 ['./commitIsolated.mjs','/work/verifier/hypothesis-worker/commitIsolated.mjs']]
 ...
 args.push('node:24-alpine','node','/work/verifier/hypothesis-worker/commitIsolated.mjs')
