...
try {
  ...
  await weather.getByText('Weather not sourced. No present-day value is substituted.',{exact:true}).waitFor()
  console.log('MIP_RECORDED_TIME_RETENTION_PASS='+JSON.stringify({explicitChoice:true,viewRoundTrip:true,outsideTimeUnplotted:true,homeRestoresRecordedGeometry:true}))
