...
// Investigation Context. Explicit result select uses the existing News
// jump handlers in App.jsx (applySubject). This helper is the contract
// seam for open / local-filter browse / dismiss — identity in, identity out.
//
 ...
 * Does not call applySubject or resetJumpContext.
 */
