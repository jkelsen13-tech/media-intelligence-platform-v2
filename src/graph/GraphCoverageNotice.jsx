...
export default function GraphCoverageNotice({ coverage, shownNodeCount, totalNodeCount }) {
  if (!coverage) return null

  const focused = Number.isInteger(shownNodeCount) && Number.isInteger(totalNodeCount) && shownNodeCount < totalNodeCount
  return (
    <section className="graph-coverage-notice" aria-labelledby="graph-coverage-title">
