...
| Membership-change invalidation | Any import that creates or changes Version Two event membership leaves the event `pending_review`. | A new import cannot silently retain or gain comparison approval. | That imports have been editorially reviewed. |
