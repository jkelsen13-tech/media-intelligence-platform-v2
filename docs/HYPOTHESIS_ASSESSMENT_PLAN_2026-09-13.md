...
| H7 — complete interaction and validation | Saved-revision selection, pending cause inspection, explicit reconciliation, client/handler/store tests, native concurrency/process loss and inherited regressions. | Authoring/reviewer completion controls, resolved-cause interaction, complete end-to-end generation workflow and rendered visual inspection. |
